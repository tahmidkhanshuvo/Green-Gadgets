...
// Blog data (should be moved to a shared data file later)
const blogPosts = {
    Recycle: [
      { id: 1, title: "How We Recycle E-Waste", 
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQo3rvtXPMoYRD34PQ7onH7Cf8Fx3O1hoqkOeaV_68kbhY1aVDyLt1Zao&s", 
        ...
        **How We Recycle:**
        ...
        { id: 2, title: "Top Tips for E-Waste Recycling", 
          image: "https://img.freepik.com/free-vector/students-learning-about-various-recyclable-materials_53876-40276.jpg?semt=ais_hybrid", 
...
Recycling e-waste isn’t just about disposing of gadgets—it’s about making smart,
 sustainable choices. Let’s reduce, reuse, and recycle for a greener future! 🌍♻️
          ...
          { id: 3, title: "The Importance of Proper Disposal", 
            image: "https://img.freepik.com/premium-vector/green-ecology-concept-with-abstract-paper-cut-background_44481-215.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid", 
            description: "A detailed guide on how we recycle e-waste efficiently.", 
            ...
            `, 
            date: "2024-02-15" },
            { id: 4, title: "The Future of E-Waste Recycling", 
              image: "https://img.freepik.com/free-vector/isometric-recycling-composition-with-isolated-view-factory-area-with-plant-building-bins-dump-truck-vector-illustration_1284-79914.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid", 
    ...
    Refurbish: [
      { id: 8, title: "How to Refurbish Your Old Laptop", image: "https://img.freepik.com/free-photo/cheerful-positive-radioman-holding-laptop-with-blank-screen-making-gesture-showing-with-forefinger-having-double-adapter-various-cords-neck-standing-with-necessary-equipment_176532-9104.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid", description: "A step-by-step guide to refurbishing your old laptop.", 
        ...
        **Steps to Refurbish:**
        ...
        { id: 9, title: "The Benefits of Refurbished Electronics", image: "https://img.freepik.com/free-vector/background-with-ecology-recycling-concept_23-2148234397.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid", description: "Why buying refurbished is a smart choice?", 
          ...
          { id: 10, title: "DIY Computer Refurbishing Tips", image: "https://img.freepik.com/premium-vector/modern-quick-tips-composition-with-flat-design_23-2147885475.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid", description: "How to refurbish and upgrade your PC.", 
            ...
            { id: 11, title: "Best Places to Buy Refurbished Gadgets", image: "https://img.freepik.com/free-photo/laptop-shopping-bags-online-shopping-concept_1423-189.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid", description: "A list of the best sites for refurbished electronics.", 
              ...
              { id: 12, title: "Refurbished product's Quality", image: "https://img.freepik.com/free-vector/character-illustration-home-improvement-concept_53876-43040.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid", description: "A step-by-step guide to refurbishing your old laptop.", 
                content: `**Why Refurbishing Matters**
                - **Saves money** by extending the life of electronics.
                - **Reduces e-waste**, contributing to a greener environment.
                - **Improves performance** with upgrades.
                ...
                **Steps to Refurbish:**
                ...
                With the right approach, your old laptop can feel brand new!`, 
                date: "2024-02-12" },
                { id: 13, title: "How we refurbish your e-wastes", image: "https://img.freepik.com/premium-photo/employee-paint-shop-automobile-plant-conducts-training-preparation-bumpers-painting_207949-113.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid", description: "A step-by-step guide to refurbishing your old laptop.", 
    ...
    "E-waste": [
      { id: 14, title: "E-Waste Management Strategies", image: "https://img.freepik.com/free-photo/man-drawing-bulb-gears_1134-465.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid", description: "The best ways to manage and reduce e-waste.", 
        ...
        { id: 15, title: "What Happens to E-Waste?", image: "https://img.freepik.com/premium-photo/large-pile-assorted-electronic-waste-including-components-devices-isolated-white-backg_829699-8257.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid", description: "The best ways to manage and reduce e-waste.", 
          ...
          { id: 16, title: "The Hidden Dangers of E-Waste", image: "https://img.freepik.com/free-vector/pollution-awareness-element-set_1284-32824.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid", description: "How e-waste harms the environment and health.", 
            ...
            { id: 17, title: "E-Waste and the Environment", image: "https://img.freepik.com/free-vector/pollution-icon-flat_98292-1496.jpg?t=st=1740156035~exp=1740159635~hmac=2669fac21b6b7279b5dc2ff1f739ad8bc3d2de1683bdd8f56715044527bc9912&w=900", description: "E-wastes destroyes the environment.", 
              content: `he environmental impact of e-waste is devastating. With millions of tons of electronic waste generated annually, landfills are overflowing, and natural resources are being depleted. The carbon footprint of manufacturing new devices is massive, making reuse and recycling more critical than ever.
              ...
              {id: 18, title: "E-waste Repair Guide", image: "https://img.freepik.com/free-vector/image-upload-landing-page_52683-23795.jpg?ga=GA1.1.896588627.1740154867&semt=ais_hybrid/400", description: "Its high time to learn how to repair e-wastes!", 
...
const BlogDetails = () => {
  ...
  const blogCategory = Object.values(blogPosts).flat();
  const blog = blogCategory.find((post) => post.id === parseInt(id));

  if (!blog) {
    return <Title level={2} style={{ textAlign: "center", marginTop: "50px" }}>Blog Not Found</Title>;
  }

  const relatedBlogs = blogCategory.filter(post => post.id !== blog.id).slice(0, 3);

  return (
    <div style={{ padding: "30px", maxWidth: "900px", margin: "auto" }}>
      <Button onClick={() => navigate("/blogs")} style={{ marginBottom: "20px" }}>← Back to Blogs</Button>
      <Card
        style={{
      ...
      >
        <Title level={2} style={{ color: "#000" }}>{blog.title}</Title>
...
<Paragraph style={{ color: "#000", whiteSpace: "pre-line" }}>{blog.content || blog.description}</Paragraph>
</Card>

{/* Related Blogs Section */}
<div style={{ marginTop: "40px" }}>
  <Title level={3} style={{ background: "linear-gradient(#579040, #487C3E)", color: 'white' }}>Related Blogs</Title>
  {relatedBlogs.map((related) => (
    <Card key={related.id} style={{ marginTop: "10px", padding: "10px", backgroundColor: "#d9fdd3" }}>
      <Title level={4}>{related.title}</Title>
